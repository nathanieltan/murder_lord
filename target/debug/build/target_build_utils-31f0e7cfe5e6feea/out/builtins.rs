static BUILTINS: phf::Map<&'static str, TargetInfo> = ::phf::Map {
    ...
    entries: ::phf::Slice::Static(&[
        ...
        ("arm-unknown-linux-musleabi", TargetInfo { arch: B("arm"), os: B("linux"), env: B("musl"), endian: B("little"), pointer_width: B("32"), switches: B(&[B("unix"), ]), other_keys: B(&[(B("target_family"), B("unix")), ]) }),
        ...
        ("x86_64-unknown-linux-musl", TargetInfo { arch: B("x86_64"), os: B("linux"), env: B("musl"), endian: B("little"), pointer_width: B("64"), switches: B(&[B("unix"), ]), other_keys: B(&[(B("target_family"), B("unix")), ]) }),
        ("thumbv7m-none-eabi", TargetInfo { arch: B("arm"), os: B("none"), env: B(""), endian: B("little"), pointer_width: B("32"), switches: B(&[]), other_keys: B(&[]) }),
        ("armv7-unknown-linux-musleabihf", TargetInfo { arch: B("arm"), os: B("linux"), env: B("musl"), endian: B("little"), pointer_width: B("32"), switches: B(&[B("unix"), ]), other_keys: B(&[(B("target_family"), B("unix")), ]) }),
        ...
        ("i686-unknown-linux-musl", TargetInfo { arch: B("x86"), os: B("linux"), env: B("musl"), endian: B("little"), pointer_width: B("32"), switches: B(&[B("unix"), ]), other_keys: B(&[(B("target_family"), B("unix")), ]) }),
        ...
        ("arm-unknown-linux-musleabihf", TargetInfo { arch: B("arm"), os: B("linux"), env: B("musl"), endian: B("little"), pointer_width: B("32"), switches: B(&[B("unix"), ]), other_keys: B(&[(B("target_family"), B("unix")), ]) }),
